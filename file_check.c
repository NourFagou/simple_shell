#include "shell.h"
/**
 * file_check - Check if the command file exists /bin/
 * @final_string: input line starting from user to check
 * Return: NULL if nothing found, otherwise the full path to the command
 */
